...
export const GiftSvg = ({size = "1em", className = "", ...props}: SizeSvg) => (
    <svg
...
export const LinkSvg = ({size = "100%", className = "", ...props}: SizeSvg) => (
    <svg
        viewBox="0 0 512 512"
        className={className}
        style={{width: size, height: size}} {...props}
...
export const LoadingSvg = ({className = "", size = "1em", ...props}: SizeSvg) => (
    <svg
        fill="currentColor" viewBox="0 0 24 24"
        className={`unic_color loading_svg ${className}`}
        style={{width: size, height: size}} {...props}
    >
        <rect className="block block-1" width="10" height="10" rx="1" />
        <rect className="block block-2" width="10" height="10" rx="1" />
    </svg>
)
...
export const EditSvg = ({size = "1em", className = "", ...props}: SizeSvg) => (
    <svg
        fill="currentColor" viewBox="0 0 24 24"
        className={className}
        style={{width: size, height: size}} {...props}
