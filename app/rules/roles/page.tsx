    ...
    return (<>
        <div className="roles_content">
            ...
            <RulesBox name="moder" heading="Модер" number={3} marker={true}>
                <DotRule>
                    Настройка и перевод плагинов, датапаков, ресурс паков и т.п.
                </DotRule>
                <DotRule>
                    Билдерство
                </DotRule>
            ...
            <RulesBox name="navigator" heading="Помогатор" number={4} marker={true}>
                <DotRule>
                    Большая категория, состоящая из 5 разделов
                </DotRule>
                <DotRule>
                    1 человек может участвовать сразу в нескольких разделах
                </DotRule>
            ...
            <RulesBox name="event" heading="Ивент мейкер" number={4.4} marker={true}>
                <DotRule>
                    Создание простых интерактивных ивентов
                </DotRule>
                <DotRule>
            ...
            <RulesBox name="seo" heading="Постер" number={4.5} marker={true}>
                <DotRule>
                    Пишет посты для телеграм и дискорд каналов
                </DotRule>
            </RulesBox>

            <RulesBox name="donate" heading="Спонсор" number={4.6} marker={true}>
                <DotRule>
                    Нет прав помогаторов
                </DotRule>
                <DotRule>
            ...
            <RulesBox name="mer" heading="Мэр" number={5} marker={true}>
                <DotRule>
                    3 мэра на каждый мир, избираются игроками на один сезон
                </DotRule>
                <DotRule>
                    В течение и в конце сезона за ухоженный и красивый спавн получает звёзды
                </DotRule>
                <DotRule>
                    Мэр имеет право запретить строительство на спавне определённым игрокам / снести постройку без
            ...
            <RulesBox name="tester" heading="Тестировщик" number={7} marker={true}>
                <DotRule>
                    Проверяет новые фичи сервера и сайта
                </DotRule>
                <DotRule>
            ...
            <RulesBox name="content" heading="Контент мейкер" number={8} marker={true}>
                <DotRule>
                    Стример / ютубер по MineBridge
                </DotRule>
                <DotRule>
                    Нужно стримить или снимать видео минимум 1 раз в 2 месяца
                </DotRule>
            </RulesBox>
        </div>
