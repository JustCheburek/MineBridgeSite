    ...
    return (<>
        <div className="rules_content">
            ...
            <RulesBox name="terms" heading="Термины" number={0}>
                ...
                <Rule number={0.8}>
                    «Сокровищница» (или «данж») — особая игровая локация, представляющая собой натуральную структуру,
                    содержащую сундуки с ресурсами и агрессивных мобов
                </Rule>
            </RulesBox>
            ...
            <RulesBox name="areas" heading="Территории" number={4}>
                <Rule number={4.1}>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <small>
                                Табличка должна быть заметной, чтобы устранить недопонимания
                            </small>
                        </li>
                    </ul>
                </Rule>
                ...
                <Rule number={4.3}>
                    <p>
                        Если вы хотите как-то дополнить эти правила, то напишите их в книжке и поставьте на главном
                        входе в кафедру
                    </p>
                    <p>
                ...
                <Rule number={4.4} text="Откуп алмазами">
                    <p>
                        При занимании места ближе, чем на 50 блоков к чужой базе или к нулевым
                        координатам, надо спрашивать их владельцев или мэра этого мира
                    </p>
                </Rule>
                ...
                <Rule number={4.6} stars={50}>
                    <p>
                        Чтобы забрать большие данжи, нужно договориться с мэром этого мира.
                        Если вы забрали данж без спроса, то эта территория является общей{" "}
                ...
                <Rule number={4.7}>
                    <p>
                        Максимальная площадь всех территорий на 1 игрока - 100000 блоков
                    </p>
                    <p>
