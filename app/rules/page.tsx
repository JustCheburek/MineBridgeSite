            ...
            <div className="rules_content">
                ...
                <RulesBox name="game_interferences" heading="Игровые помехи" number={2}>
                    ...
                    <Rule number={2.2} punishment="Суд">
                        ...
                        <ul>
                            ...
                            <li>
                                Или иметь согласие хелперов, модеров или админов
                            </li>
                        </ul>
                    </Rule>
                    <Rule number={2.3} punishment="Суд">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                модеров или хелперов, иначе вы можете понизить свой рейтинг за участие в неофициальной
                                пвп арене. {" "}
                                <TextUrl
                ...
                <RulesBox name="areas" heading="Территории" number={3}>
                    ...
                    <Rule number={3.4} punishment="Откуп алмазами">
                        <p>
                            При занимании места ближе, чем на 50 блоков к чужой базе или на 150 блоков к нулевым
                    ...
                    <Rule number={3.8} punishment={30}>
                        ...
                        <p>
                            Их нужно сносить сразу, иначе их владелец может получить понижение рейтинга
                        </p>
                    </Rule>
                </RulesBox>
                ...
                <RulesBox name="roles" heading="Роли" number={9}>
                    ...
                    <Rule number={9.2}>
                        <p>
                            Модеры и хелперы — помощники админов
                        </p>
                        <p>
                    ...
                    <Rule number={9.3}>
                        <p>
                            Админы, модеры и хелперы имеют бóльшие права, чем правила, итоговое решение остаётся за ними
                        </p>
                    </Rule>
                    <Rule number={9.4}>
                        <p>
                        ...
                        <p>
                            В течение и в конце сезона за ухоженный и красивый спавн получает мостики и социальный
                            рейтинг
                        </p>
                        <p>
