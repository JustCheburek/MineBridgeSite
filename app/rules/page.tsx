					...
					<RulesBox name="areas" heading="Территории" number={3}>
						...
						<Rule number={3.5} punishment={50}>
							...
							<ul>
								...
								<li>
									Cпавн во всех измерениях и все виды порталов к ним. Стиль спавна выбирается в телеграм канале
								</li>
								<li>
									Любые большие данжи
								</li>
						...
						<Rule number={3.6} punishment={50}>
							<p>
								Нельзя запрещать проход к данжам или убийства мобов / боссов в нём <small>(кроме фармилок мобов)</small>
							</p>
						</Rule>
						<Rule number={3.7}>
							<p>
