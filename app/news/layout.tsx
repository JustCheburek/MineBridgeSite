...
export default async function News({ children }: PropsWithChildren) {
  ...
  return (
    <MaxSize sideNav>
      <Subsections menu='Меню новостей'>
        <SubsectionItem href='/news'>Новости</SubsectionItem>
        <SubsectionItem href='/news/events'>Ивенты</SubsectionItem>
      </Subsections>
