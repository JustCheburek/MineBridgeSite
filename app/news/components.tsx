...
export const Season = (
		...
		<div className={styles.season} id={`${number}season`}>
			<div className={`${styles.time_box} ${styles.start}`}>
				...
				<time className={styles.time_text} dateTime={startData.toISOString()}>
					<strong>
						{startData.toLocaleDateString("ru-RU")}
					</strong>
				</time>
			</div>
			...
			<div className={`${styles.time_box} ${styles.end}`}>
				...
				<time className={styles.time_text} dateTime={endData.toISOString()}>
					<strong>
						{endData.toLocaleDateString("ru-RU")}
					</strong>
				</time>
			</div>
		</div>
